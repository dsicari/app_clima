package com.fatecararas.climapp
...
import com.fatecararas.climapp.model.Clima
import com.fatecararas.climapp.model.Previsao
...
private fun checkPermissions(vararg permission: String): Boolean {
    ...
    val havePermission = permission.toList().all {
        ContextCompat.checkSelfPermission(this, it) == PackageManager1.PERMISSION_GRANTED
    }
...
private fun requestWheater(): StringRequest {
    ...
    dialog.show()
    var stringRequest = StringRequest(Request.Method.GET, url, Response.Listener<String> { result ->
